                ...
                for (IrGraph graph : program) {
                        ...
                        if (spilledRegisters.get() > 0) {
                                builder.append("  push %rbp\n")
                                                .append("  mov %rsp, %rbp\n")
                                                .append("  subq $").append((spilledRegisters.get() * 4))
                                                .append(", %rsp\n");
                        }
        ...
        private static void binary(
                ...
                switch (node) {
                        ...
                        case MulNode _ -> builder.repeat(" ", 2).append("imull ")
                                        ...
                                        .append(", ")
                                        .append(target);
                        // TODO: How to handle the boolean results for the conditional jumps? Maybe use
                        // the info from the AST
                        ...
                        default ->
                                throw new UnsupportedOperationException(
                                                "Unsupported binary operation: " + node.getClass().getName());
                }
