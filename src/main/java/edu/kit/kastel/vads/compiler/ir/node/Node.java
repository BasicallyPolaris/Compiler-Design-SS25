...
public sealed abstract class Node permits BinaryOperationNode, Block, CondExprNode, ConstBoolNode, ConstIntNode, IfElseNode, IfNode, Phi, ProjNode, ReturnNode, StartNode, WhileNode {
